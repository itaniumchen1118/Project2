...
#include <cassert>
	...
	==========================
		...
		appearance in a destruction message, we know that for this test, at
		least,
		...
		test B
		Created 10(0012FEAC) // the temporary object produced by
		IntWrapper(10)
		Created 0(00322DE0) (default) // the new node created in
		Sequence::insert
		Replaced 0(00322DE0) by assigning from 10(0012FEAC) // stuffing
		Sequence::insert's
		// parameter into the new node
		Destroyed 10(0012FEAC) // after returning from Sequence::insert,
		destroy the temp
		test C
		...
		test F // We implemented Sequence::operator= using copy-and-
		swap
